...
# Función de conexión robusta (Espera a que la BD esté lista)
def get_connection():
    MAX_RETRIES = 15
    for i in range(MAX_RETRIES):
        try:
            ...
            print(f"⚠️ La base de datos aún no responde: {err}")
...
def run():
    ...
    try:
        ...
        for id_pedido in ids_pedidos:
            ...
            # 60 pedidos * 3 items = 180 registros (mínimo) -> Cumple requisito >100
